...
;(async () => {
  ...
  if ((await provider.getBalance(humanAccount1Address)) < parseEther('0.1')) {
  ...
  console.log('balance=', prebalance, 'deposit=', preDeposit)
  ...
  if (!(await deployedAccount1.deviceKeys(devicePubKey))) {
